...
(function () {
  ...
  function closeModalEl(el) {
    ...
    if (el.id === "cvModal") { var f = document.getElementById("cvFrame"); if (f) f.src = "about:blank"; }
  }
  ...
  function setCvSource(lang) {
    ...
    if (frame) frame.src = file + "#view=FitH";
    if (openTab) openTab.setAttribute("href", file);
    if (title) title.textContent = lang === "de" ? "Lebenslauf" : "Curriculum Vitae";
  }
