...
window.PORTFOLIO = {
  ...
  ui: {
    en: {
      ...
      "about.title": "About",
      "about.p1": "I am a Mechanical Engineering and Management M.Sc. graduate from Hamburg University of Technology (TUHH), with a Bachelor's background in Mechanical Engineering from Gujarat Technological University, India. My main focus is <strong>mechanical design, CAD/CAE, product development, and manufacturability</strong>.",
      "about.p2": "Across my projects and professional experience, I have worked on mechanical component design, simulation, additive manufacturing, regenerative braking, topology optimization, and functional prototypes. I enjoy turning engineering requirements into practical designs using tools such as CATIA, Siemens NX, SolidWorks, Fusion 360, AutoCAD, and ANSYS.",
      "about.p3": "Alongside my technical design background, I bring project management, process improvement, and data-driven problem-solving experience. In industry, I contributed to a 35% reduction in production waste and automated technical documentation with Python/VBA, reducing documentation effort by 75%.",
  ...
  projects: [
    ...
    {
      year: "2021", img: "assets/img/regen_braking.svg", repo: "regenerative-braking-bicycle",
      title: { en: "Regenerative Braking System for Bicycles", de: "Regeneratives Bremssystem für Fahrräder" },
      role: { en: "Bachelor Thesis · CAD + Simulation", de: "Bachelorarbeit · CAD + Simulation" },
      desc: {
        en: "A complete energy-recovery braking solution designed as a modular front-wheel attachment for standard bicycles. Modelled and simulated in Fusion 360, SolidWorks and ANSYS to validate the energy-recovery mechanism.",
        de: "Eine vollständige rekuperative Bremslösung als modularer Vorderradanbausatz für herkömmliche Fahrräder. Modelliert und simuliert in Fusion 360, SolidWorks und ANSYS zur Validierung der Energierückgewinnung."
      },
      tags: ["Fusion 360", "SolidWorks", "ANSYS", "CAD"]
    },
    {
