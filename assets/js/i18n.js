...
window.PORTFOLIO = {
  ...
  ui: {
    en: {
      ...
      "hero.lead": "M.Sc. candidate at TU Hamburg. I design, optimize and 3D-print functional mechanical parts — from topology-optimized structures to single-print mechanisms.",
      ...
      "contact.lead": "Open to internships, working-student roles and collaboration in additive manufacturing, product design and simulation.",
  ...
  timeline: [
    ...
    {
      type: "work", period: "07/2023 – 03/2026",
      badge: { en: "Working Student", de: "Werkstudent" },
      title: { en: "Cashier &amp; Print Services", de: "Kassierer &amp; Druckservice" },
      org: { en: "TUHH Campus-Shop GmbH, Hamburg", de: "TUHH Campus-Shop GmbH, Hamburg" },
      points: {
        en: ["Advised international students and lecturers in a multicultural environment.",
             "Printing &amp; binding of theses, posters and technical documents with high accuracy and deadline reliability.",
             "Inventory, stock-taking and cash handling (LaCash) alongside full-time master's study."],
        de: ["Beratung internationaler Studierender und Dozenten im multikulturellen Umfeld.",
             "Druck &amp; Bindung von Abschlussarbeiten, Plakaten und technischen Unterlagen mit hoher Genauigkeit und Termintreue.",
             "Warenwirtschaft, Inventur und Kassenführung (LaCash) neben dem Vollzeit-Masterstudium."]
      }
    },
    {
    ...
    },
    {
      ...
      org: { en: "Gujarat Technological University, India — Grade 1.7", de: "Gujarat Technological University, Indien — Note 1,7" },
      points: { en: [], de: [] }
    }
  ],
